...
class CitiesTableStruct
{
    public static $columnID = "cities_id";
    public static $columnName = "cities_name";
}

class CitiesTable
{
    var $currentTable = TABLE_CITIES;
    ...
    public function Update($whereText = "")
    {
        ...
        $queryText = sprintf($format, $this->currentTable,
            CitiesTableStruct::$columnName, $data, $isWhere);
