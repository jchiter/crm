...
class EventTableStruct
{
    public static $columnID = "events_id";
    public static $columnName = "events_name";
}

class EventTable
{
    var $currentTable = TABLE_EVENTS;
    ...
    public function Update($whereText = "")
    {
        ...
        $queryText = sprintf($format, $this->currentTable,
            EventTableStruct::$columnName, $data, $isWhere);
