...
class OrderStatusTableStruct
{
    public static $columnID = "order_status_id";
    public static $columnValue = "order_status_value";
    public static $columnColor = "order_status_color";
    public static $columnOperaion = "order_operation";
}

class OrderStatusTable
{
    var $currentTable = TABLE_ORDER_STATUS;
    public $currentStruct = OrderStatusTableStruct;
    ...
    public function Insert()
    {
        ...
        $queryText = sprintf($format, $this->currentTable,
            OrderStatusTableStruct::$columnValue,
            $data);
    ...
    public function Update($whereText = "")
    {
        ...
        $queryText = sprintf($format, $this->currentTable,
            OrderStatusTableStruct::$columnValue, $data, $isWhere);
