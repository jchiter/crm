...
class PrepayTableStruct
{
    public static $columnID = "prepay_id";
    public static $columnValue = "prepay_value";
}

class PrepayTable
{
    var $currentTable = TABLE_PREPAY;
    public $currentStruct = PrepayTableStruct;
    ...
    public function Update($whereText = "")
    {
        ...
        $queryText = sprintf($format, $this->currentTable,
            PrepayTableStruct::$columnValue, $data, $isWhere);
